...
public class FollowGUIVelocityPath extends NotifierCommand {
	 ...
	 */
	public FollowGUIVelocityPath(PointProfile profile) {
		this(profile, false);
	}
	 ...
	 *            initial heading of the robot according to the path
	 */
	public FollowGUIVelocityPath(PointProfile profile, boolean mirror) {
		super(5);
