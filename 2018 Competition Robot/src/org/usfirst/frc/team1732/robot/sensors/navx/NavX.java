...
public class NavX extends GyroBase {
	...
	private void addToDashboard() {
		...
		// Robot.dash.add(imu + "IMU_CompassHeading",
		// () -> navx.getCompassHeading());

		/* Display 9-axis Heading (requires magnetometer calibration to be useful) */
		// Robot.dash.add(imu + "IMU_FusedHeading", () -> navx.getFusedHeading());
		 ...
		 */
		Robot.dash.add(imu + "YawAxisDirection", () -> navx.getBoardYawAxis().up ? "Up" : "Down");
		Robot.dash.add(imu + "YawAxis", () -> navx.getBoardYawAxis().board_axis.getValue());
